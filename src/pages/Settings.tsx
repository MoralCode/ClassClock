            ...
            <input type="checkbox" id="use24HourTime"  />
                ...
                <section id="credits" className="centered topSpace">
                    <ul className="footer__social">
                        <li><a href="{{ site.githubURL }}"><i className="fab fa-github" aria-hidden="true" /></a></li>
                        <li><a href="{{ site.twitterURL }}"><i className="fab fa-twitter" aria-hidden="true" /></a></li>
                        <li><a href="{{ site.instagramURL }}"><i className="fab fa-instagram" aria-hidden="true" /></a></li>
                    </ul>
                    <p id="credits">
